          ...
          <Col className="lg-7 md-10 xs-12">
            <Box className="banner-content"> 
              ...
              <Text as="span" className="description">
                Safe bring investor to Pluto with Proof of Burn mechanism (POB) and auto liquidity AMM.
              </Text>
              ...
              <Box className="banner-btn">
                <Link href="https://t.me/safeplutoxyz">
                  <a className="btn btn-fill"> <FaTelegram />Telegram</a>
                </Link> 
              </Box>
            </Box>
          </Col>
